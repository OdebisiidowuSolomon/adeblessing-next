...
import "@/public/assets/css/post-15.css";
...
export const metadata: Metadata = {
    title: "About Us",
    description: "We offer the highest levels of professionalism and sanitation for our clients while providing the best services and keeping our prices reasonable.",
};
...
function AboutLayout({
    ...
    return (
        <html lang="en">
            ...
            <body
                className={`page-template-default page page-id-15 wp-custom-logo wp-embed-responsive ehf-header ehf-footer ehf-template-beautifly ehf-stylesheet-demo-child no-wc-breadcrumb elementor-default elementor-kit-6 elementor-page elementor-page-15`}
            >
                <div id="page" className="hfeed site">
                    <PublicHeader />
                    <PublicBreadCrumb title='About Us' />
                    {children}
                    <PublicFooter />
                </div>
