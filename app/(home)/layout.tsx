...
function HomeLayout({
    ...
    return (
        <html lang="en">
            ...
            <body
                className={`page-template-default page page-id-10 wp-custom-logo wp-embed-responsive ehf-header ehf-footer ehf-template-beautifly ehf-stylesheet-demo-child no-wc-breadcrumb elementor-default elementor-kit-6 elementor-page elementor-page-10`}
            >
                <div id="page" className="hfeed site">
                    <HomeHeader />
                    {/* <PublicBreadCrumb title='Contact' /> */}
                    {children}
                    <HomeFooter />
                </div>
        ...
        window.RS_MODULES.type = 'compiled';`}
            ...
            for (let j = 0; j < urlFields.length; j++) {
                ...
                <>
                    ...
                    <Script src="/assets/js/our-service.js" id="beautifly-elementor-our-service-js"></Script>

                    <Script src="/assets/js/TweenMax.min.js" id="tweenmax-js"></Script>
                    <Script src="/assets/js/video.js" id="beautifly-elementor-video-js"></Script>
                    <Script src="/assets/js/posts-grid.js" id="beautifly-elementor-posts-grid-js"></Script>
